...
public class AccountController {
	...
	//User
	@PostMapping("/login")
	public ResponseEntity<List<Account>> loginUser(@RequestBody Account acc){
		return new ResponseEntity<List<Account>> (accSer.loginUser(acc.getUsername(), acc.getPassword()), HttpStatus.OK);
	}
